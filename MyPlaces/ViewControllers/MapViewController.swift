...
//  MyPlaces
//
//  Created by Дмитрий Писляков on 16.05.2022.
//
...
class MapViewController: UIViewController {
    ...
    var mapViewContollerDelegate: MapViewControllerDelegate?
    var place = Place()
    ...
    @IBAction func doneButtonPressed() {
        mapViewContollerDelegate?.getAddress(currentAddressLabel.text)
...
extension MapViewController: CLLocationManagerDelegate {
    ...
    func locationManagerDidChangeAuthorization(_ manager: CLLocationManager) {
        ...
        mapManager.checkLocationAuthorozation(mapView: mapView,
