...
//  MyPlaces
//
//  Created by Дмитрий Писляков on 19.05.2022.
//
...
class MapManager {
    ...
    func checkLocationAuthorozation(mapView: MKMapView, incomeSegueIdentifier: String) {
    ...
    func checkLocationServices(mapView: MKMapView, segueIdentifier: String, closure: () -> ()) {
        if CLLocationManager.locationServicesEnabled() {
            ...
            checkLocationAuthorozation(mapView: mapView, incomeSegueIdentifier: segueIdentifier)
            closure()
        } else {
            DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
                self.showAlert(title: "Location Services are disabled",
